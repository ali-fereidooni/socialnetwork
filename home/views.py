...
class PostDetailView(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        return render(request, 'home/detail.html', {'post': post, 'comments': comments, 'form': self.form_class, 'reply_form': self.form_class_reply})
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            new_comment.save()
            messages.success(request, 'You commented on this post', 'success')
...
class PostCreateView(LoginRequiredMixin, View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            new.save()
            messages.success(
                request, 'you created new post successfully', 'success')
...
class PostAddReplyView(LoginRequiredMixin, View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            reply.save()
            messages.success(
                request, 'ypur reply submitted successfully', 'success')
        return redirect('home:post_detail', post.id, post.slug)
